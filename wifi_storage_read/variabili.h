...
#define SECRET_SSID     "STORAGE_READ_SAVE"
#define SECRET_PASS     "AtmRHsuLw"
#define STORAGE_BUFFER 500
enum nomeVar1 { RAGGIO, IMP, POS_APERTO, POS_CHIUSO, VELOCITA_BASSA, VELOCITA_MEDIA, VELOCITA_ALTA, MOTORE, ENCODER, CONFIGURAZIONE, POS, CADENZA, CONSUMO_BASSA_MAX, CONSUMO_MEDIA_MAX, CONSUMO_ALTA_MAX} ;
const static struct {
  nomeVar1     val;
  const char *str;
} conversion [] = {
